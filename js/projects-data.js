...
window.PROJECTS = [
...

  {
    ...
    "results": {
      "before": ["Visualization literacy treated as binary — either you can read charts or you can't", "Educational interventions focused on chart-making skills rather than chart-reading skills", "No clear taxonomy of visualization literacy failure modes in the existing literature"],
      "after": ["Proposed a four-level literacy framework from basic chart reading to critical evaluation of visualization choices and their rhetorical implications", "Documented the specific failure modes most common at each literacy level", "Identified annotation and guided interpretation as the highest-evidence interventions for improving comprehension at scale without sacrificing analytical depth"]
    },
    "takeaways": [
...

{
  ...
  "quotes": [
    ...
    {
      "text": "Thank you for putting us in this mindset to speak a different language.",
      "attribution": "UNDL staff, final presentation",
